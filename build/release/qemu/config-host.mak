...
all:
prefix=/home/wsu001/build/release/qemu
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu= -lutil -lncurses -ltinfo -lbrlapi  -luuid  -lrdmacm -libverbs -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.5.0
PKGVERSION=
SRC_PATH=/home/wsu001/projs/esesc/emul/qemu
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/wsu001/build/release/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
